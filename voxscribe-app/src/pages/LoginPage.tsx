      ...
      <div className="hidden lg:flex lg:w-1/2 items-center justify-center p-12 relative">
        ...
        <div className="relative z-10 text-center text-white">
          ...
          <div className="relative">
            ...
            {/* Speech bubble */}
            <div className="absolute -top-4 -right-8 w-32 h-20 bg-white dark:bg-gray-800 rounded-3xl flex items-center justify-center shadow-lg">
              <div className="text-gray-600 dark:text-gray-300 text-sm font-medium">Hello!</div>
            </div>
          </div>
          
          <p className="text-xl mt-8 text-white/90">
            Real-time speech transcription and translation for seamless global communication
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 dark:text-blue-400 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 rounded focus:ring-blue-500 dark:focus:ring-blue-400"
                />
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-blue-600 dark:bg-blue-700 hover:bg-blue-700 dark:hover:bg-blue-600 disabled:bg-blue-400 dark:disabled:bg-blue-800 text-white font-medium py-3 rounded-lg transition-colors focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900"
            >
              {isLoading ? (
